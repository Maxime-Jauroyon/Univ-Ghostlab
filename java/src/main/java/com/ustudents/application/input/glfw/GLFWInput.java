package com.ustudents.application.input.glfw;
...
import com.ustudents.application.window.events.CursorMovedEvent;
...
import com.ustudents.application.window.events.ScrollMovedEvent;
