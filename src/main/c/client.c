...
int main(int argc, char **argv) {
    ...
    if(r != -1) {
    ...
    
        {
            ...
            gl_message_push_parameter(&msg, (gl_message_parameter_t) {.uint8_value = 7});
            gl_message_write(fd, &msg);
            gl_message_free(&msg);
        }
    ...
    
        {
            ...
            gl_message_push_parameter(&msg, (gl_message_parameter_t) {.uint8_value =  5});
            gl_message_push_parameter(&msg, (gl_message_parameter_t) {.uint16_value =  265});
            gl_message_push_parameter(&msg, (gl_message_parameter_t) {.uint16_value =  345});
            gl_message_write(fd, &msg);
            gl_message_free(&msg);
        }
    ...
    
        {
            ...
            gl_message_push_parameter(&msg, (gl_message_parameter_t) {.uint8_value =  5});
            gl_message_push_parameter(&msg, (gl_message_parameter_t) {.uint16_value =  12});
            gl_message_write(fd, &msg);
            gl_message_free(&msg);
        }
    ...
    
        {
            ...
            gl_message_push_parameter(&msg, (gl_message_parameter_t) {.string_value = gl_string_create_from_cstring(
                "02dfgd gdfg dsfgdfg dfsdg dfg dsgdfg 3")});
            gl_message_write(fd, &msg);
            gl_message_free(&msg);
        }
